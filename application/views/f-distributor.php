<div class="box">
        ...
        <div class="title">
                <h5>Distributor</h5>
                <ul class="links">
                        <li><a href="<?=base_url().$this->uri->segment(1)."/".$this->uri->segment(2)?>/new">New Distributor</a></li>
                ...
                <div class="form">
                        <div class="fields">
                                ...
                                <div class="field">
                                        ...
                                        <div class="input">
                                                <input type="text" id="distributor_add" name="distributor_add" value="<?=$data['distributor_add']?>" class="medium" />
                                        </div>
                                </div>
                                <div class="buttons">
                ...
                <table id="records">
                        <thead>
                                <tr>
                                        ...
                                        <th>Distributor Add</th>
                                        <th>Actions</th>    
                                </tr>
                        </thead>
                        <tbody></tbody>
                </table>
                <?=$this->load->view("grid-distributor");?>
        </div>
</div>