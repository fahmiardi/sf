<div class="box">
        ...
        <div class="title">
                <h5>Return</h5>
                <ul class="links">
                        <li><a href="<?=base_url().'index.php/'.$this->uri->segment(1)."/".$this->uri->segment(2)?>">Create Return</a></li>
                        <li><a href="<?=base_url().'index.php/'.$this->uri->segment(1)."/".$this->uri->segment(2)?>chart">List Return</a></li>
                </ul>
        </div>
        <!-- end box / title -->
        ...
        <div class="table">
                ...
                <?php
                if($jenis == "create"){
                        $this->load->view('f-returns-create');
                }elseif($jenis == "chart"){
