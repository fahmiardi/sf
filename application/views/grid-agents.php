...
var readUrl   = 'index.php/act_agents/read',
    updateUrl = 'index.php/master/agents/update',
    delUrl    = 'index.php/act_agents/delete',
    delHref,
    updateHref,
    updateId;
    ...
    $.ajax({
        ...
        success: function( response ) {
            ...
            for( var i in response ) {
                response[ i ].updateLink = updateUrl + '/' + response[ i ].agent_id;
                response[ i ].deleteLink = delUrl + '/' + response[ i ].agent_id;
                response[ i ].nomor = j;
                j++;
            }
            //clear old rows
