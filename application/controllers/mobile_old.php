						...
						if(count($getfield))
						{
							...
							foreach($getfield as $fields)
							{
								if($fields['t_elm_type'] == "radio" || $fields['t_elm_type'] == "checkbox" || $fields['t_elm_type'] == "dropdown")
								{
									...
									{		
										if(count($getsource) > 0)
										{
											...
											{
													$isi .= "<input type=radio name='".$fields['t_services_column']."' value='".$detailsource['jjj1']."' /> ".$detailsource['jjj0']."<br/>";
											}
										}
									}
									elseif($fields['t_elm_type'] == "checkbox")
									{
										if(count($getsource) > 0)
										{
											foreach($getsource as $detailsource)
											{
													$isi .= "<input type=checkbox name='".$fields['t_services_column']."[]' value='".$detailsource['jjj1']."' /> ".$detailsource['jjj0']."<br/>";
											}
										}
									}
									else
									{
										$isi .= "<select name='".$fields['t_services_column']."'>";
										if(count($getsource) > 0)
										{
											foreach($getsource as $detailsource)
											{
								...
								elseif($fields['t_elm_type'] == "text")
									$isi .= $fields['t_elm_label']."<br/><input type=text name='".$fields['t_services_column']."'/><br/>";
								elseif($fields['t_elm_type'] == "textarea")
									$isi .= $fields['t_elm_label']."<br/><textarea name='".$fields['t_services_column']."' cols='30' rows='5'/></textarea><br/>";
								elseif($fields['t_elm_type'] == "gps")
									$isi .= "<a href=\"javascript:window.HTMLOUT.accessLocation('gps');\"><img src='images/gps.png' width='28' height='28' align='left'/>&nbsp;".$fields['t_elm_label']."</a><input type='hidden' name='".$fields['t_services_column']."'/><br/>";
								elseif($fields['t_elm_type'] == "img")
									$isi .= "<a href=\"javascript:window.HTMLOUT.accessMedia('camera');\"><img src='images/img.png' width='28' height='28' align='left'/>&nbsp;".$fields['t_elm_label']."</a><input type='hidden' name='".$fields['t_services_column']."'/><br/>";
								elseif($fields['t_elm_type'] == "barcode")
									$isi .= "<a href=\"javascript:window.HTMLOUT.accessBarcode();\"><img src='images/barcode.png' width='28' height='28' align='left'/>&nbsp;".$fields['t_elm_label']."</a><input type='hidden' name='".$fields['t_services_column']."'/><br/>";
								elseif($fields['t_elm_type'] == "date")
								{
									$isi .= "<a href=\"javascript:window.HTMLOUT.accessDate('".$datecek."');\"><img src='images/date.png' width='28' height='28' align='left'/>&nbsp;".$fields['t_elm_label']."</a><input type='hidden' name='".$fields['t_services_column']."'/><br/>";
									$datecek++;
								}
							...
							$forms = "<html><body style='background:><form method=post action='http://202.53.249.209/smartfren/index.php/adddynamicform'><input type=hidden name=serviceid value=".$tableget['services_id']."><input type=hidden name=tablename value=".$tableget['services_tabel'].">$isi<input type=submit value='kirim'></form>".$jsnya."</html>";
							write_file("formgenerate/".$tableget['services_tabel'].".html",$forms);

							$tablelist[$rowx] = array("form_id" => $tableget['services_id'], "form_name" => "form/".$tableget['services_name'], "form_download_url" => "http://202.53.249.209/smartfren/formgenerate/".$tableget['services_tabel']);
