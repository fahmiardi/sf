	...
	public function addoutlet()
	{
		...
		if(!empty($_FILES['outlet_foto']['name']))
		{
			...
			if ($this->upload->do_upload('outlet_foto'))
            {
				...
				$this->Mobile_model->add_territorymtruser($userid,$territoryidlast);
				$outletidlast = $this->Mobile_model->add_outlet($userid,$territoryidlast,$outletname,$outletaddress,$outletcity,$longitude,$latitude,"file/outlet/".$_FILES['outlet_foto']['name'],$outletbf);
